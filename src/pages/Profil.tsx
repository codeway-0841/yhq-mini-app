...
// Telegram WebApp type augmentation for requestContact
declare global {
  interface Window {
    Telegram?: {
      WebApp?: {
  ...
  return (
    <button
      ...
      className={`flex items-center gap-3 w-full px-4 py-3.5 border-b border-[#30363d] last:border-0 transition-colors ${
        ...
        danger ? 'active:bg-[#21262d]' : 'active:bg-[#21262d]'
...
export default function Profil() {
  ...
  const handleAddPhone = () => {
    ...
    tgWebApp.requestContact((ok, data) => {
      ...
      // Telegram gives phone without leading +, normalize to E.164
  ...
  return (
    <div className="pt-4 pb-8">
      ...
      <Section title="SIZNING TARIFINGIZ">
        ...
        />
        <Item icon={Lock} iconBg="bg-purple-600" label="Yopiq guruh" right={<span className="text-xs text-[#8b949e]">Qo'shilish</span>} />
      </Section>
