...
function TopBar({ user, onSettings }) {
    ...
    <div className="pb-4">
      ...
      <div className="grid grid-cols-2 gap-3 px-4 mb-3">
        ...
        <GridCard icon={AlertTriangle} label="Xatolarni tuzatish"
          badge={totalWrong || null} color="#2a1c1c" onClick={goTest} />
      </div>
      ...
      {/* Row 2 */}
      <div className="grid grid-cols-2 gap-3 px-4 mb-3">
        <GridCard icon={Play} label="Test yechish" color="#1a3a1a" onClick={goTest} />
        <GridCard icon={Sword} label="Oktagon" color="#1e1e1e"
          className="opacity-60" onClick={() => {}} />
      </div>

      {/* 2×2 grid A */}
      <div className="grid grid-cols-2 gap-3 px-4 mb-3">
        <GridCard icon={LayoutGrid}    label="Mavzular"       color="#1c2a3a" onClick={goTest} />
        <GridCard icon={Ticket}        label="Biletlar"       color="#1c2a3a"
      ...
      <div className="grid grid-cols-2 gap-3 px-4">
        ...
        <GridCard icon={BookOpen}      label="Yo'l belgilari"   color="#1a1c2a"
          onClick={() => navigate('/belgilar')} />
