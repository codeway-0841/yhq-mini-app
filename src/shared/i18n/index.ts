...
const UZ = {
  ...
  shareResult: "Natijani ulashish", shareResultImage: "Rasm qilib ulashish", backWord: "Orqaga",
...
const RU: Record<Keys, string> = {
  ...
  shareResult: "Поделиться результатом", shareResultImage: "Поделиться картинкой", backWord: "Назад",
