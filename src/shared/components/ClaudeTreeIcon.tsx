...
/**
 * Tarif darajasi ikonkasi (geometrik piksel-daraxt, currentColor) —
 * SubscriptionModal'dagi tarif kartalari ikonkasi. YAGONA MANBA:
 * ClosedGroupSheet kabi boshqa upsell joylari ham SHUNI ishlatadi.
 */
export const ClaudeTreeIcon = memo(function ClaudeTreeIcon({ className, style }: {
  className?: string
  style?: CSSProperties
}) {
  return (
