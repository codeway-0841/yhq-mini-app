...
export interface PremiumIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string
  className?: string
}

/**
 * Premium (Olmos / Diamond) ikonkasi — brend Premium SVG ikonkasi.
 * YHQ platformasi bo'ylab Premium statusi va tariflari uchun yagona vizual.
 */
export const PremiumIcon = memo(function PremiumIcon({
  size = 16,
  className = '',
  style,
  ...props
