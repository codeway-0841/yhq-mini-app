...
/**
 * Sozlamalar (cog) ikonkasi — SMIL animatsiyali SVG (chizilib ochiladi +
 * 30s davriy sekin aylanish), stroke=currentColor — matn rangini meros qiladi.
 * Lucide `Settings` o'rniga brend ikonkasi (TopBar / TestPage).
 */
const SettingsIcon = memo(function SettingsIcon({ className }: { className?: string }) {
  return (
