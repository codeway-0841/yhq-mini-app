    ...
    return (
      <div className="min-h-screen bg-pcanvas flex items-center justify-center px-6">
        <div className="rounded-2xl bg-pcard p-8 text-center shadow-xs">
          ...
          <button
            onClick={() => navigate('/')}
            className="bg-pprimary text-ponprimary font-semibold hover:brightness-[1.06] active:scale-[0.98] disabled:opacity-[0.42] disabled:pointer-events-none transition-[transform,filter] duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pprimary focus-visible:ring-offset-2 px-6 py-2.5 rounded-2xl font-semibold text-[14px] shadow-xs"
          >
