      ...
      {STUDY_ITEMS.map((it, i) => {
        ...
        return (
          <button
            ...
            className={`bg-psurface text-pfg border border-plineStrong active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none transition-[transform,background-color,border-color,color,filter] duration-[120ms] flex items-center gap-2 pl-3 pr-4 py-2.5 rounded-full text-[12px] font-semibold transition-all duration-300 pointer-events-auto ${
