      ...
      >
        ...
        {isSuccess ? (
          <div className="py-8 text-center space-y-4">
            ...
            <button
              onClick={onClose}
              className="bg-pprimary text-ponprimary font-semibold hover:brightness-[1.06] active:scale-[0.98] disabled:opacity-[0.42] disabled:pointer-events-none transition-[transform,filter] duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pprimary focus-visible:ring-offset-2 flex items-center justify-center gap-2 w-full py-3 rounded-2xl text-sm shadow-xs"
            >
