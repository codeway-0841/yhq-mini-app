  ...
  return (
    <div className="mb-5 px-4">
      <div className="mb-2.5 flex items-center justify-between">
        ...
        <button
          onClick={onSeeAll}
          className="flex min-h-11 items-center gap-0.5 rounded-xl text-[13px] font-semibold text-pprimary transition-opacity active:opacity-70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pprimary"
        >
