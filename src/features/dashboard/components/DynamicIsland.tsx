              ...
              <div className="grid grid-cols-2 gap-2.5">
                {actions.map(({ label, Icon, run }) => (
                  <button
                    ...
                    className="group flex flex-col items-center justify-center gap-2.5 py-4 px-2 rounded-2xl bg-pcard dark:bg-[rgb(var(--p-surface-rgb)/0.8)] shadow-xs hover:bg-psurface active:scale-[0.96] transition-all text-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pprimary"
                  >
