      ...
      <div className="rounded-container border border-pline bg-pcard p-4 flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="btn-neon flex items-center gap-2 px-4 py-2 rounded-control text-[13px] font-semibold disabled:opacity-50"
          >
              ...
              {c.status !== 'sent' && (
                <>
                  ...
                  <button
                    ...
                    disabled={isSending}
                    className="btn-neon flex items-center justify-center gap-2 px-4 py-2 rounded-control text-[13px] font-semibold disabled:opacity-50"
                  >
                    {isSending
