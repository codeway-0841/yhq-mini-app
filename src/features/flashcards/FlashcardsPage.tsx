  ...
  if (done) {
    return (
      <div className="font-display bg-pcanvas text-pfg flex flex-col items-center justify-center min-h-[60vh] px-6 text-center">
        ...
        <button onClick={() => start(cat)} className="bg-pprimary text-ponprimary font-semibold hover:brightness-[1.06] active:scale-[0.98] transition-[transform,background-color,filter] duration-150 rounded-2xl flex h-12 items-center gap-2 px-8 font-semibold mb-3 shadow-xs">
