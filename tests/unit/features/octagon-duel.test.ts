...
describe('duelReducer', () => {
  ...
  it('MATCHED — matchId/opponent saqlanadi, score nol', () => {
    const s = duelReducer({ ...DUEL_INIT, phase: 'searching' },
      { type: 'MATCHED', matchId: 'm9', opponentName: 'X', opponentAvatar: '/api/avatar/u1', opponentFrame: 'frame-fire', roundCount: 10 })
    expect(s).toMatchObject({ phase: 'matched', matchId: 'm9', opponentName: 'X', opponentAvatar: '/api/avatar/u1', opponentFrame: 'frame-fire', roundCount: 10 })
  })
