...
export const GOLDEN_FIXTURES: Record<string, GoldenExpectation> = {
  ...
  'mtp-algebra-geometriya-014-18': {
    externalId: 'mtp-algebra-geometriya-014-18',
    forbiddenInQuestion: ['\\operatorname{\\operatorname{'],
    requiredInQuestion: ['\\operatorname{ctg}', '\\operatorname{tg}'],
    forbiddenInOptions: ['\\operatorname{\\operatorname{'],
    expectedOptions: {
      A1: '- \\frac{9}{13} .',
      A2: '- \\frac{1}{11} .',
      A3: '- \\frac{2}{11} .',
  ...
  'mtp-algebra-geometriya-063-18': {
    externalId: 'mtp-algebra-geometriya-063-18',
    forbiddenInQuestion: ['\\pin', '\\pik'],
    requiredInQuestion: ['Tenglamani yeching:'],
    forbiddenInOptions: ['\\pin', '\\pik'],
    expectedOptions: {
      A1: '\\pi n',
      A2: '\\pi n',
      A3: '\\pi n',
  ...
  'mtp-algebra-geometriya-095-01': {
    externalId: 'mtp-algebra-geometriya-095-01',
    forbiddenInQuestion: ['Variant-95', 'Variant', '1.'],
    requiredInQuestion: ['Natural n sonining kvadrati 4 ga'],
    forbiddenInOptions: [],
    expectedOptions: {
      A1: '1; 2; 3.',
      A2: '1; 2.',
  ...
  'mtp-algebra-geometriya-065-04': {
    externalId: 'mtp-algebra-geometriya-065-04',
    forbiddenInQuestion: [],
    requiredInQuestion: ['Ifodani soddalashtiring:'],
    forbiddenInOptions: ['+.', '-.', '*.', '/.'],
    expectedOptions: {
      A1: '2 x + 1.',
      A2: 'x + 2 .',
  ...
  'mtp-algebra-geometriya-064-04': {
    externalId: 'mtp-algebra-geometriya-064-04',
    forbiddenInQuestion: ['\\left(\\left(', '\\right)\\right)'],
    requiredInQuestion: ['ifodani soddalashtiring:'],
    forbiddenInOptions: [],
    expectedOptions: {
      A1: 'b \\cdot \\left(b - a \\right) .',
      A2: '2 b \\cdot \\left(a + b \\right) .',
      A3: 'b .',
      A4: '2 b .',
    },
    correctAnswer: 'A4',
  ...
  'mtp-algebra-geometriya-056-20': {
    externalId: 'mtp-algebra-geometriya-056-20',
    forbiddenInQuestion: ['⎧', '⎨', '⎪', '⎩', '\x0e', 'a^{2} _{1}'],
    requiredInQuestion: ['cases', 'a_{1}^{2}'],
    forbiddenInOptions: [],
    expectedOptions: {
      A1: '150 yoki 245.',
      A2: '153 yoki 317.',
