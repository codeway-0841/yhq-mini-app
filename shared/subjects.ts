...
export const SUBJECT_BASES = [
  ...
  { id: 'matematika', name: 'Matematika',              nameRu: 'Математика',                 icon: 'π',  dataSourceId: 'math_db',          available: true,  demoData: false, examPresets: ['milliy-sertifikat', 'attestatsiya'], closedGroupUrl: 'https://t.me/+kiwi_matematika_group' },
  { id: 'kimyo',      name: 'Kimyo',                   nameRu: 'Химия',                      icon: '🧪', dataSourceId: 'chemistry_db',     available: true,  demoData: false, examPresets: ['milliy-sertifikat', 'attestatsiya'], closedGroupUrl: 'https://t.me/+kiwi_kimyo_group' },
  { id: 'ingliz',     name: 'Ingliz tili',             nameRu: 'Английский язык',            icon: '🇬🇧', dataSourceId: 'english_db',       available: true,  demoData: false, examPresets: ['milliy-sertifikat', 'attestatsiya'], closedGroupUrl: 'https://t.me/+kiwi_ingliz_group' },
  { id: 'tarix',      name: 'Tarix',                   nameRu: 'История',                    icon: '📖', dataSourceId: 'history_db',       available: true,  demoData: false, examPresets: ['milliy-sertifikat', 'attestatsiya'], closedGroupUrl: 'https://t.me/+kiwi_tarix_group' },
  { id: 'biologiya',  name: 'Biologiya',               nameRu: 'Биология',                   icon: '🧬', dataSourceId: 'biology_db',       available: true,  demoData: false, examPresets: ['milliy-sertifikat', 'attestatsiya'], closedGroupUrl: 'https://t.me/+kiwi_biologiya_group' },
  { id: 'geografiya', name: 'Geografiya',              nameRu: 'География',                  icon: '🌍', dataSourceId: 'geography_db',     available: true,  demoData: false, examPresets: ['milliy-sertifikat', 'attestatsiya'], closedGroupUrl: 'https://t.me/+kiwi_geografiya_group' },
  { id: 'onatili',    name: 'Ona tili',                nameRu: 'Родной язык',                icon: '📚', dataSourceId: 'onatili_db',       available: true,  demoData: false, examPresets: ['milliy-sertifikat', 'attestatsiya'], closedGroupUrl: 'https://t.me/+kiwi_onatili_group' },
  { id: 'adabiyot',   name: 'Adabiyot',                nameRu: 'Литература',                 icon: '✒️', dataSourceId: 'adabiyot_db',      available: true,  demoData: false, examPresets: ['milliy-sertifikat', 'attestatsiya'], closedGroupUrl: 'https://t.me/+kiwi_adabiyot_group' },
