...
export const savedRepository = {
  ...
  async add(userId: string, questionId: number, subjectId: string = DEFAULT_SUBJECT_ID): Promise<void> {
    try {
  ...
  async remove(userId: string, questionId: number, subjectId: string = DEFAULT_SUBJECT_ID): Promise<void> {
